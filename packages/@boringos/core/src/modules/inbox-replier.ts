...
export const REPLIER_AGENT_INSTRUCTIONS_FOR_TEST = [
  ...
  "    Where <MERGED_OBJECT_HERE> = {replyDrafts: [...existing.replyDrafts || [], {author: 'inbox-replier', draftedAt: '<ISO>', body: '<your draft text>'}]} — read the item first to get existing.replyDrafts.",
