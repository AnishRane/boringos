...
//
// `slack` connector Module — wrapper around the existing
// SlackClient. Tools mirror 's actions exactly (send_message,
// reply_in_thread, add_reaction); each handler looks up the
// tenant's stored credentials and delegates to the same client.
//
// Phase 7 of task_12. 's `/api/connectors/actions/slack/*` route
